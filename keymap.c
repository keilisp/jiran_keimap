...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [L_EN] = LAYOUT(
           ...
           LA_CHNG,       KC_TAB,  EN_Q,    EN_W,    EN_E,    EN_R,      EN_T,                                         EN_Y,    EN_U,    EN_I,    EN_O,     EN_P,     EN_GRV,   AG_SLSH,
                          LOTH,    EN_A,    EN_S,    EN_D,    EN_F,      EN_G,                                         EN_H,    EN_J,    EN_K,    EN_L,     AG_SCLN,  EN_AT,  
                          SFT_N,   EN_Z,    EN_X,    EN_C,    EN_V,      EN_B,                                         EN_N,    EN_M,    AG_EQL,  AG_UNDS,  AG_DOT,   AG_COMM,
                                                              AWSM_T,    KC_SPC, KC_LCTL,                   KC_LALT,   ENRU_BSP,NUKE_ENT
  ),
  ...
  [L_EN_S] = LAYOUT(
           ...
           LA_CHNG,       KC_TAB,  EN_S_Q,  EN_S_W,  EN_S_E,  EN_S_R,    EN_S_T,                                       EN_S_Y,  EN_S_U,  EN_S_I,  EN_S_O,   EN_S_P,   _______,  AG_BSLS,
                          ...
                          SFT_N,   EN_S_Z,  EN_S_X,  EN_S_C,  EN_S_V,    EN_S_B,                                       EN_S_N,  EN_S_M,  _______,  _______, AG_EXCL,  EN_CIRC,
                                                              _______,   KC_SPC, KC_LCTL,                   KC_LALT,   ENRU_BSP,NUKE_ENT
  ),
  ...
  [L_RU] = LAYOUT(
           ...
           LA_CHNG,       KC_TAB,  RU_J,    RU_TS,   RU_U,    RU_K,    RU_JE,                                          RU_N,    RU_G,    RU_SH,   RU_SC,    RU_Z,     RH_UJI,   AG_SLSH,
                          LOTH,    RU_F,    RY_UI,   RU_V,    RU_A,    RU_P,                                           RU_R,    RU_O,    RU_L,    RU_D,     RU_ZH,    RE_UJE,
                          SFT_N,   RU_JA,   RU_CH,   RU_S,    RU_M,    RU_I,                                           RU_T,    RU_SF,   RU_B,    RU_JU,    AG_DOT,   AG_COMM,
                                                              AWSM_T,   KC_SPC,  KC_LCTL,                   KC_LALT,   RUEN_BSP,NUKE_ENT
  ),
  ...
  [L_RU_S] = LAYOUT(
           ...
           LA_CHNG,       KC_TAB,  RU_S_J,  RU_S_TS, RU_S_U,  RU_S_K,  RU_S_JE,                                        RU_S_N,  RU_S_G,  RU_S_SH, RU_S_SC,  RU_S_Z,   RH_UJI, AG_BSLS,
                          ...
                          SFT_N,   RU_S_JA, RU_S_CH, RU_S_S,  RU_S_M,  RU_S_I,                                         RU_S_T,  RU_S_SF, RU_S_B,  RU_S_JU,  AG_EXCL,  EN_CIRC,
                                                              _______, KC_SPC,   KC_LCTL,                   KC_LALT,   RUEN_BSP,NUKE_ENT
  ),
  ...
  [L_UA] = LAYOUT(
           ...
           LA_CHNG,       KC_TAB,  UA_J,    UA_TS,   UA_U,    UA_K,    UA_E,                                           UA_N,    UA_G,    UA_SH,   UA_SC,    UA_Z,     UA_H,     EN_SLSH,
                          LOTH,    UA_F,    UA_I,    UA_V,    UA_A,    UA_P,                                           UA_R,    UA_O,    UA_L,    UA_D,     UA_ZH,    UA_JE,
                          SFT_N,   UA_JA,   UA_CH,   UA_S,    UA_M,    UA_Y,                                           UA_T,    UA_SF,   UA_B,    UA_JU,    AG_DOT,   AG_COMM,
                                                              AWSM_T,   KC_SPC,  KC_LCTL,                   KC_LALT,   UAEN_BSP,NUKE_ENT
  ),
  ...
  [L_UA_S] = LAYOUT(
           ...
           LA_CHNG,       KC_TAB,  UA_S_J,  UA_S_TS, UA_S_U,  UA_S_K,  UA_S_E,                                         UA_S_N,  UA_S_G,  UA_S_SH, UA_S_SC,  UA_S_Z,   UA_S_H,   EN_BSLS,
                          LOTH,    UA_S_F,  UA_S_I,  UA_S_V,  UA_S_A,  UA_S_P,                                         UA_S_R,  UA_S_O,  UA_S_L,  UA_S_D,   UA_S_ZH,  UA_S_JE,
                          SFT_N,   UA_S_JA, UA_S_CH, UA_S_S,  UA_S_M,  UA_S_Y,                                         UA_S_T,  UA_S_SF, UA_S_B,  UA_S_JU,  AG_EXCL,  EN_CIRC,
                                                              _______, KC_SPC,   KC_LCTL,                   KC_LALT,   UAEN_BSP,NUKE_ENT
  ),

  [L_OTHER] = LAYOUT(
                          KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,                                          KC_F7,   KC_F8,   KC_F9,   KC_F10,   KC_F11,   KC_F12,
           LA_SYNC,       KC_TAB,  EN_CJSLB,EN_LTEQ, EN_LCBR, EN_RCBR, EN_ARR2,                                        KC_HOME, KC_PGDN, KC_PGUP, KC_END,   KC_NO,    KC_NO,    KC_DEL,
                          LOTH,    EN_CJST, EN_LT,   AG_LPRN, AG_RPRN, EN_GT,                                          KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT,  KC_NO,    KC_NO,
                          SFT_N,   EN_CJIF, EN_GTEQ, EN_LBRC, EN_RBRC, EN_ARR1,                                        CTL_LEFT,CTL_DOWN,CTL_UP,  CTL_RGHT, KC_NO,    KC_NO,
                                                                   KC_LSFT, KC_SPC, KC_LCTL,                RESET,     KC_BSPC, KC_PSCR
  ),
  ...
  [L_NUKE_WAR] = LAYOUT(
           ...
           KC_MENU,       KC_TAB,   _______,   _______,  _______,   _______,   _______,                          _______, KC_PAST, KC_P4,   KC_P5,   KC_P6,  KC_PPLS,     KC_NLCK,
                          ...
                          KC_RALT,  SFT_N,     KC_LSFT,  KC_LGUI,   _______,   _______,                          _______, _______, KC_P0,   KC_PDOT, KC_PCMM,KC_PEQL,
                                                                          KC_RSFT, KC_SPC, KC_RCTL,         KC_NO,     KC_BSPC, NUKE_ENT
  ),
